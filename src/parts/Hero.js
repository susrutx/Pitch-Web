  ...
  return (
    <section className="hero">
      <div className="w-full lg:w-1/2 xl:pl-12 sm:pr-2 mt-8">
        <h1 className="text-5xl sm:text-6xl text-teal-500 font-bold leading-tight mb-5">
          Imagine a World <br />
          Of Transparent Healthcare
        </h1>

        <p className="font-light text-xl text-gray-400 leading-relaxed mb-16">
          Control over your own Medical data with everything under one hood.
        </p>
      ...
      <div className="flex pt-5 md:w-fit w-full justify-center items-center order-first md:order-first lg:order-last lg:w-1/2">
        <Fade direction="up" triggerOnce>
          <img className="h-96 w-96" src={Heroimg} alt="Build Website" />
        </Fade>
      </div>
    </section>
  );

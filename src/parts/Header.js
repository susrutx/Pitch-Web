  ...
  return (
    <header className="header">
      <div className="flex justify-between px-4 lg:px-0">
        ...
        <button className="block text-black lg:hidden focus:outline-none" onClick={() => setIsCollapse(!isCollapse)}>
      ...
      <ul className="hidden tracking-widest items-center lg:flex flex-row mt-0">
        ...
        <li className="py-2 lg:py-0">
          <Button
            className={`${
              path === '/team' ? 'text-teal-500' : 'text-black'
            } font-medium text-lg px-5 no-underline hover:underline`}
            type="link"
            href="/team"
          >
        ...
        <div className="transition duration-300 ease-in data-[closed]:opacity-0">
          <ul className="z-50 flex flex-col tracking-widest my-6 absolute bg-white w-full border-b-2 border-gray-300 lg:hidden">
            ...
            <li className="mx-auto my-9 bg-white">
              <Button
                className="font-bold mx-auto px-5 py-2 bg-teal-600 text-white rounded-full border-2 border-teal-600 hover:bg-teal-700 transition duration-200"
                type="link"
                href="/discuss-project"
              >
                Contact
